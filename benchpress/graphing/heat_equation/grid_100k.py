...
#setup step:
avg_arr = np.loadtxt('../bench_results/100k_500/test3.txt')
min_max_arr = np.empty([2,3000])
min_max_arr[0] = np.loadtxt('../bench_results/100k_500/test3.txt')
min_max_arr[1] = np.loadtxt('../bench_results/100k_500/test3.txt')
...
for i in range(4,134):
	counter += 1
	curr_exec = np.loadtxt('../bench_results/100k_500/test' + str(i) + '.txt')
...
plt.savefig('grid_100k.png', dpi=250)
